...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div id="page_container">
      ...
      <p align="right">
        <button type="button" class="btn btn-default" id="add_type">
            <small><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></small> Add Type(s)
        </button>
      </p>
          ...
          <div class="table-responsive col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Types Catalog</h3>
              </div>
